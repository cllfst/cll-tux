...
pygame.init()
DISPLAYSURF = pygame.display.set_mode((665, 374))
...
#  Hurt image
pingImgHurt = pygame.image.load('hurt.png').convert_alpha()
...
#  obstacle
obs = pygame.image.load('Danger-icon.png').convert_alpha()
DISPLAYSURF.blit(obs, (200, 500))
position_obstacle = obs.get_rect(center=(500, 335))

DISPLAYSURF.blit(obs, (300, 500))
position1_obstacle = obs.get_rect(center=(650, 335))



BACKGROUND = pygame.image.load('fond2.jpg').convert()
